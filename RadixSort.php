...
Iterate through Digits: Iterate through each digit position (from the least significant digit to the most significant digit) of
 the numbers.

Bucket Distribution: Place each number into one of the buckets based on the value of the current digit being processed.

Collecting Buckets: After distributing all numbers into buckets for the current digit position, collect the 
numbers back from the buckets in the order they appear (from bucket 0 to bucket 9).
